...
CASE("causality")
{
        ...
        CHECK(!mli_Ray_intersects_triangle(
                mli_Ray_set(
                        mli_Vec_set(0.0, 1.0, z), mli_Vec_set(0.0, 0.0, 1.0)),
                a,
                b,
                c,
                &param));
