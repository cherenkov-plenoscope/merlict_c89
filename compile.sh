...
echo "gcc_c89"
gcc merlict-c89-test.c -o test_gcc_c89 -std=c89 -lm -Wall -pedantic
./test_gcc_c89  > test_gcc_c89.o 2> test_gcc_c89.e
tail -n 1 test_gcc_c89.o

echo "gcc"
gcc merlict-c89-test.c -o test_gcc -lm -Wall -pedantic
...
echo "clang_c89"
clang merlict-c89-test.c -o test_clang_c89 -std=c89 -lm -Wall -pedantic
./test_clang_c89 > test_clang_c89.o 2> test_clang_c89.e
tail -n 1 test_clang_c89.o

echo "clang"
clang merlict-c89-test.c -o test_clang -lm -Wall -pedantic
