...
#include "../../mli/src/mliImage_ppm.h"
#include "../../mli/src/mliPinHoleCamera.h"
#include "../../mli/src/mliApertureCamera.h"
#include "../../mli/src/mli_ray_scenery_query.h"
#include "../../mli/src/mli_version.h"
