...
void mliRotMat_init_tait_bryan(
    const double rx,
    const double ry,
    const double rz,
    mliRotMat *rot) {
...
void mli_transform_orientation(
    const mliRotMat *rot,
    const mliVec *in,
    mliVec *out) {
...
void mli_transform_orientation_inverse(
    const mliRotMat *rot,
    const mliVec *in,
    mliVec *out) {
...
void mli_transform_position_inverse(
    const mliRotMat *rot,
    const mliVec *trans,
    const mliVec *in,
    mliVec *out) {
