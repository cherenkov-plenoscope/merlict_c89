...
struct mliPrng mliPrng_init_MT19937(const uint32_t seed)
{
        ...
        prng.generate_uint32 = mliPrng_mliMT19937_generate_uint32;
        prng.reinit = mliPrng_mliMT19937_reinit;
        return prng;
}
...
struct mliPrng mliPrng_init_PCG32(const uint32_t seed)
{
        ...
        prng.generate_uint32 = mliPrng_mliPCG32_generate_uint32;
        prng.reinit = mliPrng_mliPCG32_reinit;
        return prng;
}
