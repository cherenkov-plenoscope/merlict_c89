...
{
        uint64_t i, j;
        mli_check_message(a->num_nodes == b->num_nodes, "num_nodes not equal.");
        mli_check_message(
        ...
        mli_check_message(a->cube.lower.x == b->cube.lower.x, "cube.lower.x not eaual");
        mli_check_message(a->cube.lower.y == b->cube.lower.y, "cube.lower.y not eaual");
        mli_check_message(a->cube.lower.z == b->cube.lower.z, "cube.lower.z not eaual");
        mli_check_message(
                a->cube.edge_length == b->cube.edge_length,
                "cube.edge_length not eaual");

        mli_check_message(a->root_type == b->root_type, "cube.root_type not eaual");
