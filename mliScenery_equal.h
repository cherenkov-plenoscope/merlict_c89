...
int _mliScenery_functions_equal(
...
int mliScenery_is_equal(const struct mliScenery *a, const struct mliScenery *b)
{
        ...
        if (!_mliScenery_spheres_equal(a, b)) return 0;
        if (!_mliScenery_cylinders_equal(a, b)) return 0;
        if (!_mliScenery_hexagons_equal(a, b)) return 0;
        if (!_mliScenery_bicircleplanes_equal(a, b)) return 0;
        if (!_mliScenery_discs_equal(a, b)) return 0;
        return 1;
}
