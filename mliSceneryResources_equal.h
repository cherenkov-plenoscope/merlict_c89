...
#ifndef MERLICT_MLISCENERYRESOURCES_EQUAL_H_
#define MERLICT_MLISCENERYRESOURCES_EQUAL_H_
...
int mliSceneryResources_equal(
        ...
        const struct mliSceneryResources* b)
{
        if (!_mliSceneryResources_functions_equal(a, b)) return 0;
        if (!_mliSceneryResources_colors_equal(a, b)) return 0;
        if (!_mliSceneryResources_media_equal(a, b)) return 0;
        if (!_mliSceneryResources_surfaces_equal(a, b)) return 0;
        return 1;
}
